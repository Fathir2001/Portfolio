        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <p className="text-lg text-accent-400 dark:text-gray-300 transform transition-transform duration-300 hover:scale-105">
              I'm a dedicated Full Stack Developer with expertise in Mobile and Web Development, specializing in building seamless experiences with Flutter and React.
            </p>
            <p className="text-lg text-accent-400 dark:text-gray-300 transform transition-transform duration-300 hover:scale-105">
              My goal is to transform creative concepts into impactful digital solutions through well-structured, optimized, and scalable code. I strive to build applications that are both highly functional and a pleasure for users to interact with.
            </p>
          ...
          >
            ...
            >
              ...
              <ul className="space-y-3 text-gray-200 dark:text-gray-300">
                <li className=' transform transition-transform duration-300 hover:scale-105'>📧 rifathanfathir33@gmail.com</li>
                <li className=' transform transition-transform duration-300 hover:scale-105'>💼 Full Stack & Mobile Developer</li>
                <li className=' transform transition-transform duration-300 hover:scale-105'>🚀 Specialized in Flutter & React</li>
                <li className=' transform transition-transform duration-300 hover:scale-105'>🎯 Focus on Clean Architecture</li>
                <li className=' transform transition-transform duration-300 hover:scale-105'>📱 Mobile & Web Development Expert</li>
              </ul>
            </motion.div>
          </motion.div>
        </div>
