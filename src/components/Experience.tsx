...
const experiences = [
  {
    ...
    period: "2024 - Present",
    description:
      "Collaborated with a dynamic team to create engaging content, manage social media presence, and enhance brand visibility.",
  },
  {
    ...
    period: "2021 - Present",
    description:
      "Led initiatives to strengthen connections, organized events to support school development, and fostered community engagement. Spearheaded projects benefiting both current students and the broader school community.",
  },
  {
    ...
    period: "2025 - Present",
    description:
      "Gaining hands-on experience in full-stack development, contributing to real-world projects, and enhancing technical skills in a professional environment.",
  },
];
...
const Experience = () => {
  return (
    <section
      id="experience"
      className="py-20 bg-gradient-to-br from-primary-900 to-primary-800"
    >
              ...
              >
                ...
                >
                  <div
                    ...
                    style={{
                      boxShadow:
                        "0 0 10px rgba(59, 130, 246, 0.4), 0 0 20px rgba(59, 130, 246, 0.2), 0 0 30px rgba(59, 130, 246, 0.1)",
                    }}
                  >
                    ...
                    <div
                      className={`flex items-center gap-2 text-white dark:text-gray-400 mt-2 ${
                        index === 1 ? "justify-end" : ""
                      }`}
                    >
